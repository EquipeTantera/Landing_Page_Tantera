    ...
    const fetchProductsData = async () => {
      try {
        ...
        const formattedProducts = products.map((product) => {
          ...
          // Formatação dos dados do produto
          return {
            ...
            sizes,
            genres,
            categories, // As categorias do produto
        ...
        <section className={styles.section}>
          ...
          <div className={styles["container-products"]}>
            {filterProductsByCategory("Acessórios de Festa").length > 0 &&
              filterProductsByCategory("Acessórios de Festa").map(
                (product, index) => (
                  <SmallProductCard
                    key={index}
                    title={product.title}
          ...
          >
            {showMoreFesta ? (
              ...
              <p className={styles["container-products__button__paragraph"]}>
                ...
                <span
                  className={
                    styles["container-products__button__paragraph__span"]
                  }
                >
                  acessórios de festa
                </span>
